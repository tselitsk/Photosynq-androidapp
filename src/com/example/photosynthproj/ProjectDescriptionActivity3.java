...
public class ProjectDescriptionActivity3 extends Activity {
...
TextView nameOfPerson_tv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_project_description_activity3);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(
				R.menu.activity_project_description_activity3, menu);
		return true;
	}
